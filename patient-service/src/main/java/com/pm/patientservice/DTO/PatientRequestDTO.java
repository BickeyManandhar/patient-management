...
public class PatientRequestDTO {
    ...
    public @NotBlank(message = "Email is required.") @Email(message = "Email should be valid.") @Size(max = 100, message = "Name cannot exceed 100 characters.") String getEmail() {
        return email;
    }

    public void setEmail(@NotBlank(message = "Email is required.") @Email(message = "Email should be valid.") @Size(max = 100, message = "Name cannot exceed 100 characters.") String email) {
        this.email = email;
    }
